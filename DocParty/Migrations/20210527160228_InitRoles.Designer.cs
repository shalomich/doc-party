...
namespace DocParty.Migrations
{
    ...
    [Migration("20210527160228_InitRoles")]
            ...
            modelBuilder.Entity("DocParty.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "8fbf0b12-bcff-406e-91ed-60ae1ad0b04c",
                            Name = "Creator"
                        },
                        new
                        {
                            Id = 2,
                            ConcurrencyStamp = "2b0e059f-55d3-4559-8159-1e9ba8388641",
                            Name = "Author"
                        });
                });

            modelBuilder.Entity("DocParty.Models.UnauthorizedAuthor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
